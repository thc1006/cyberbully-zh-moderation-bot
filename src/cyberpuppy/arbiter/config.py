    ...
    def __init__(self):
        ...
        self.perspective = PerspectiveConfig(
            ...
            requests_per_second=int(
                os.getenv("PERSPECTIVE_RATE_LIMIT_RPS", "1")
            ),
            requests_per_day=int(
                os.getenv("PERSPECTIVE_RATE_LIMIT_DAY", "1000")
            ),
        ...
        self.uncertainty = UncertaintyConfig(
            uncertainty_threshold=float(
                os.getenv("UNCERTAINTY_THRESHOLD", "0.4")
            ),
        ...
        return {
            ...
            "uncertainty": {
                "uncertainty_threshold": (
                    self.uncertainty.uncertainty_threshold
                ),
