...
DEFAULT_ADAPTER = "models/cyberpuppy_v2_2_qwen3_8b/best"
...
def main() -> None:
    ...
    ap.add_argument("--out", default="reports/v2_2_comprehensive_eval.json")
    args = ap.parse_args()
    ...
    all_results["multisource_test"] = eval_jsonl(
        tokenizer, model, device,
        Path("data/processed/v2/v2_2_test.jsonl"), "multisource test", args.batch,
    )
    ...
    Path(args.out).write_text(
        json.dumps({
            "model": "cyberpuppy_v2_2_qwen3_8b",
